            ...
            <container-fluid className='container1'>
                <div className='row mb-4'>
                    <div className='col text-center mb-2'>
                        <div className="card col-lg-8 col-md-10 col-sm-12 mx-auto bg-secondary text-warning">
                            <div className="card-body">
                                ...
                                For more details about this journey, please click the links in the top menu, or click this button
                                </p>
                                <div button className='btn btn-danger'>Yes, this Button</div>
                                <p>to go straight to my personal info.</p>
                            </div>
                        </div>
                    </div>

                    <div className='col text-center'>
                        <div className="card col-lg-9 col-md-10 col-sm-12 mx-auto bg-secondary text-warning">
                            <div className="card-body">
                                ...
                                <iframe className='col-lg-12 col-md-12 col-sm-12' width="500" height="300" src="https://www.youtube.com/embed/jM8dCGIm6yc" frameborder="0"
